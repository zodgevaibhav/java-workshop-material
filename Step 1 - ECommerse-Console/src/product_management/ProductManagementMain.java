...
public class ProductManagementMain {
	...
	public static void productManagement() { // Entry point => User defined Method
		...
		while (shallIKeepRunningCode) {
			...
			case 1:
				...
				product.printProduct();// Function Call
			...
			case 2:
				...
				break;
			case 3:
				System.out.println("Search product operation not yet implemented");
				break;
			case 4:
